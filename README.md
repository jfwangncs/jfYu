...
- [Office](https://github.com/jfwangncs/jfYu/tree/master/src/jfYu.Core/jfYu.Core.Office) - 基于NPOI的组件，Excel:便捷导入导出的方法，支持超大数据导出,Word：图片的模板插入.
- [Wechat](https://github.com/jfwangncs/jfYu/tree/master/src/jfYu.Core/jfYu.Core.Wechat) - 微信小程序,公众号的快捷操作.
